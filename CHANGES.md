...
- Add Fedora 44 (OCaml 5.4.0) (@avsm #266)
...
- Add `tar` to the openSUSE/SLES dev package list; the Leap base image
  no longer ships it (@mtelvers, #264)
...
- Deprecate Ubuntu 24.10, EOL 10 July 2025. (@mtelvers, #238)

v8.3.0 2025-08-19
-----------------

- Add Debian 13 (Trixie). (@MisterDA, #237)
- Add Alpine 3.22 (@mtelvers, #236)
...
- Update DNF > 3 command line (@mtelvers, #223)
