...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5159eb94bf607fd5ec989de3fd4dc0f7) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Dockerfile_opam"; "Dockerfile_distro"];
                      lib_pack = false;
                      lib_internal_modules = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\213\177\162[6\128p\143\178\194\023\251HX\214\206";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
