...
(* OASIS_START *)
(* DO NOT EDIT (digest: 53f0fb39a07c32a3a6e9197bbff904a2) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "lib";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "dockerfile"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      lib_modules = ["Dockerfile_opam"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "dockerfile";
                      lib_findlib_name = Some "opam";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "opam-cmdliner";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "dockerfile";
                           InternalLibrary "opam";
                   ...
                   {
                      lib_modules = ["Dockerfile_opam_cmdliner"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "dockerfile";
                      lib_findlib_name = Some "opam-cmdliner";
                      lib_findlib_containers = []
                   });
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for ocaml-dockerfile";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "­ae\140D7.\026\000\002F\1302\137UC";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
